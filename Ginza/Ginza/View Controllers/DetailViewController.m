...
- (void)viewDidLoad
{
   ...
   // Offer *offer =  [appDeligate getOfferDataById:offerId];
    ...
    NSString *details =@"利用条件                                                                                                      座ダイナー スクラブカード本会員様 および家族会員様と、その同伴者1名 様まで無料でご利用いただけます。以 降は、同伴者1名様につき1,050円（税込）をご請求させていただきます(お支払いは銀座ダイナースクラブカードをご利用くださ い)。  ";
